...
def perceptron(input, weights):
    ...
    It then uses the activate function to return either 1 or -1 depending on
    whether the dot product is positive or negative. It takes the following arguments:
    ...
    # The following line does the same as the line above, however it is slower:
